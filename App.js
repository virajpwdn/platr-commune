...
const restaurantList = [
    {
      ...
      analytics: {
        context: "seo-data-76752cf7-37f2-467d-a1a7-6c40d7b4a593",
      },
      cta: {
...
const ResturantCardContainer = (props)=>{
    console.log(props)
    return (
        <div className="res-container">
            ...
            <h3>{props.resturantList[0].info.name}</h3>
            <h4></h4>
            <p>4.5 stars</p>
...
const Body = () =>{
    return (
        <div className="content">
            <ResturantCardContainer resturantList={restaurantList} />
            <ResturantCardContainer resturantList={restaurantList} />
        </div>
    )
}
